            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle"
                        src="{{asset('teacher_images/'.$teacher->image)}}" alt="User profile picture">
                    ...
                    <div class="tab-pane" id="timeline">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="inputName" id="inputName" class="form-control" value="{{ $teacher->first_name }} {{ $teacher->last_name }}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail" class="col-sm-3 control-label">Email</label>
                                <div class="col-sm-9">
                                    <input type="text" name="inputEmail" id="inputEmail" class="form-control" value="{{ $teacher->email }}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="inputDob" id="inputDob" class="form-control" value="{{ $teacher->dob }}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPhone" class="col-sm-3 control-label">Phone No.</label>
                                <div class="col-sm-9">
                                    <input type="text" name="inputPhone" id="inputPhone" class="form-control" value="{{ $teacher->phone }}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassport" class="col-sm-3 control-label">Passport No.</label>
                                <div class="col-sm-9">
                                    <input type="text" name="inputPassport" id="inputPassport" class="form-control" value="{{ $teacher->passport }}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputAddress" class="col-sm-3 control-label">Address</label>
                                <div class="col-sm-9">
                                    <textarea  name="inputAddress" id="inputAddress" class="form-control"   disabled>{{$teacher->address}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputNationality" class="col-sm-3 control-label">Nationality</label>
                                <div class="col-sm-9">
                                    <input type="text" name="inputNationality" id="inputNationality" class="form-control" value="{{ $teacher->nationality }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="inputRegisteredDate" id="inputRegisteredDate" class="form-control" value="{{date("Y-m-d",strtotime($teacher->dateregistered))}}" disabled>
                                </div>
                            </div>
