    ...
    <table class="table" id="classSchedules-table">
        ...
        @foreach($classSchedules as $classSchedule)
            ...
            <td>{{ $classSchedule->status }}</td>
                <td>
                    {!! Form::open(['route' => ['classSchedules.destroy', $classSchedule->schedule_id], 'method' => 'delete']) !!}
                    <div class='btn-group'>
                        <a href="{{ route('classSchedules.show', [$classSchedule->schedule_id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                        <a href="{{ route('classSchedules.edit', [$classSchedule->schedule_id]) }}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
